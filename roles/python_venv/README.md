...
| python_venv_requirements_file_packages   | no       |         |         | List of packages to be added to the requirements.txt file in the Python virtual environment. (Name, Version - optional). |
